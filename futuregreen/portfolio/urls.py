...
urlpatterns = patterns('',
   ...
   url(r'^projects/type/(?P<slug>[-\w]+)/$', ProjectProjectTypeListView.as_view(), name = 'portfolio_project_projecttype'),
   url(r'^projects/landscape/(?P<slug>[-\w]+)/$', ProjectLandscapeTypeListView.as_view(), name = 'portfolio_project_landscapetype'),
